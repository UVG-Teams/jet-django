"""
Django settings for jetDjango project.
...
SECRET_KEY = 'krs@8_-fl*wd3!xog2&km#8y2npx)55o02a_v@r6s40v0y!9w3'
...
WSGI_APPLICATION = 'jetDjango.wsgi.application'
